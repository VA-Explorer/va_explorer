# Generated by Django 3.0.8 on 2020-07-15 22:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('verbalautopsy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='verbal_autopsy.VerbalAutopsy')),
            ],
        ),
    ]
