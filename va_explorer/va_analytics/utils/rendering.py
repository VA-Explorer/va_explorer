    ...
    if va_stats:
        ...
        if va_stats["last_update"] or va_stats["last_submission"]:
            if va_stats["last_update"]:
                update_desc = html.P(children=[html.I("Last Data Update: "), va_stats["last_update"]], style={"margin-left": "20px"})
                header.children.append(update_desc)
            if va_stats["last_submission"]:
                submission_desc = html.P(children=[html.I("Last VA Submission: "), va_stats["last_submission"]], style={"margin-left": "10px"})
