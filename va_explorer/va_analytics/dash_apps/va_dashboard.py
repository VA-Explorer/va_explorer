...
def update_callouts(
    ...
    return [
        ...
        make_card(coverage, header="Region Representation", tooltip="% of regions with data within geography type - ie. Districts with data within Provice or Provices with data within Country", style={"width": "225px"}),
    ]
