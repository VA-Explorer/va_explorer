...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        vasubset= codva[{"id","Id10019","Id10021","Id10023","ageInYears2",
                         "cause","metadataCode","odkMetaInstanceID"}]
        ...
        settingsDHIS = ntDHIS("http://localhost:8081/dhis2_343", "admin", "district", "ueouZ9IAydX")
